...
namespace GatewayWebAPI.Controllers
{
    ...
    {
        public static IResult ProcessarPagamento(RequisicaoPagamento dados, AppDbContext banco)
        {
        ...
        public static IResult ProcessarCheckout(RequisicaoPagamento dados, AppDbContext banco)
        {
